...
(
    ...
    dietary_group_id bigint not null,
    primary key (restaurant_id, dietary_group_id)
);
...
(
    ...
    dietary_group_id bigint not null,
    primary key (client_id, dietary_group_id)
);
...
ALTER TABLE restaurant_dietary_group
    DROP CONSTRAINT IF EXISTS FK_RDG_DIETARY_GROUPS_REFERENCE;
...
-- Adds fk constraint
ALTER TABLE restaurant_dietary_group
    DROP CONSTRAINT IF EXISTS FK_RDG_RESTAURANTS_REFERENCE;
...
ALTER TABLE client_dietary_group
    DROP CONSTRAINT IF EXISTS FK_CDG_CLIENTS_REFERENCE;
...
-- Adds fk constraint
ALTER TABLE client_dietary_group
    DROP CONSTRAINT IF EXISTS FK_CDG_DIETARY_GROUPS_REFERENCE;
